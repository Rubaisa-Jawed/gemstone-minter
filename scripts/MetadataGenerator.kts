...
fun getDescriptionForId(id: Int): String{
    return when(id){
        ...
        1-> "An Sapphire gemstone that only exists on the Ethereum blockchain.\\n" +
                "A commemorative token for the purchase of Malt, Grain & Cane's Curated Range bottlings (Year 2).\\n" +
        ...
        3-> "An Citrine gemstone that only exists on the Ethereum blockchain.\\n" +
                "A commemorative token for the purchase of Malt, Grain & Cane's Curated Range bottlings (Year 2).\\n" +
        ...
        5-> "An Ruby gemstone that only exists on the Ethereum blockchain.\\n" +
                "A commemorative token for the purchase of Malt, Grain & Cane's Curated Range bottlings (Year 2).\\n" +
